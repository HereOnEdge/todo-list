...
let detailShower = () => {
    ...
    for (let project of projects) {
        ...
        spanTitle.addEventListener("click", () => {
            ...
            function addTaskButton() {
                ...
                addTask.addEventListener("click", () => {
                    ...
                    setTimeout(() => {
                        ...
                        let timeIcon = document.querySelector(`.timepicker${projectObject.id}`);
            ...
            let display = displayTasks(projectObject, project, tasksContainer);
