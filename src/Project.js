...
export default function Project(projectName, projectID, projectDescription) {
  ...
  const addTask = (taskName, taskDate, taskTime, taskTag, taskImportant) => {
    const newTask = Task(taskName, taskDate, taskTime, taskTag, taskImportant);
...
const project1 = Project(
  "todo-list",
  0,
  "make a web application for managing your todo's and projects",
  "Work"
);
...
const project2 = Project(
  "Advanced JavaScript",
  1,
  "Read all the Advanced topics in Odin Project",
  "educate"
);
